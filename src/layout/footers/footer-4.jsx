            ...
            <div className="footer-top">
                ...
                <ul className="shape-group shape-group-2">
                    <li className="shape-1 scene">
                        <img data-depth="-3" src="/assets/images/others/shape-06.png" alt="shape" />
                    </li>
                    <li className="shape-2 scene">
                        <img data-depth="3" src="/assets/images/others/shape-07.png" alt="shape" />
                    </li>
                    <li className="shape-3">
                        <img src="/assets/images/about/shape-10.png" alt="shape" />
                    </li>
                    <li className="shape-4 scene">
                        <img data-depth="2" src="/assets/images/others/shape-08.png" alt="shape" />
                    </li>
                    <li className="shape-5 scene">
                        <img data-depth="-2" src="/assets/images/others/shape-09.png" alt="shape" />
                    </li>
                </ul>
            </div>
