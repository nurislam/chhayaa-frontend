            ...
            <div className="footer-top">
                                ...
                                <div className="inner">
                                    ...
                                    <div className="widget-information">
                                        <ul className="information-list">
                                            ...
                                            <li><span>Email:</span><a href="mailto:info@Chhayaa.com"
                ...
                <ul className="shape-group">
                    <li className="shape-1 scene" data-sal-delay="100" data-sal="fade" data-sal-duration="1000">
                        <img data-depth="-2" src="/assets/images/others/shape-01-01.png" alt="shape" />
                    </li>
                    <li className="shape-2 scene" data-sal-delay="100" data-sal="fade" data-sal-duration="1000">
                        <img data-depth="2" src="/assets/images/others/shape-02-01.png" alt="shape" />
                    </li>
                    ...
                    <li className="shape-4 scene" data-sal-delay="100" data-sal="fade" data-sal-duration="1000">
                        <img data-depth="-2" src="/assets/images/others/shape-04-01.png" alt="shape" />
                    </li>
                    <li className="shape-5 scene" data-sal-delay="100" data-sal="fade" data-sal-duration="1000">
                        <img data-depth="2" src="/assets/images/others/shape-05-01.png" alt="shape" />
                    </li>
                </ul>
            </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="inner text-center">
                                <p>Copyright {new Date().getFullYear()} <a href="https://1.envato.market/AoJezj" rel="noreferrer" target="_blank">Chhayaa</a> Designed By <a href="https://1.envato.market/YgGJbj" target="_blank" rel="noreferrer">DevsBlink</a>. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
