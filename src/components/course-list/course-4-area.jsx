...
const CourseFourArea = () => {
    ...
    const {
        ...
        include: [
            ...
            {
                relation: "lessons",  // Make sure this is included
                scope: {
                    fields: { id: true, name: true, courseId: true, identifier: true },
                },
            },
            {
                relation: "instructor",
                scope: {
                    fields: { id: true, name: true, identifier: true },
                },
            },
        ],
    ...
    // .filter((item) => {
    //     console.log('Checking price filter', item.price, price);
    //     if (!price || price.length !== 2) {
    //         return true; // Show all courses when no price range is selected
    //     }
    //     return Number(item.price) >= price[0] && Number(item.price) <= price[1];
    // });
            ...
            <div className="container">
                <div className="row g-5">
                    <div className="col-lg-3">
                        ...
                        <CourseSidebar course_data={course_data} course_items={course_items} />
                        {/* course sidebar end */}
                    </div>
