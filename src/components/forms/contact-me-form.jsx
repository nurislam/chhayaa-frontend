        ...
        <form className="rnt-contact-form rwt-dynamic-form" onSubmit={ sendEmail }>
            <div className="row row--10">
                ...
                <div className="form-group col-12">
                    <input type="tel" name="phone" onChange={e => setPhone(e.target.value)} placeholder="Phone number" />
                </div>
                <div className="form-group col-12">
                    <textarea name="message" onChange={e => setMessage(e.target.value)} cols="30" rows="6" placeholder="Type your message"></textarea>
                </div>
